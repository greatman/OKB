				...
				if (!(newrankid < 0)) {
					if (track.get(newrankid) != null) {
						...
						if (rankidentifiers.containsKey(newrank.toLowerCase())) {
							...
							sendMessage(ChatColor.GOLD + "Notice: " + ChatColor.GRAY + "'" + ChatColor.WHITE + name + ChatColor.GRAY + "' was demoted to '" + ChatColor.WHITE + rankidentifiers.get(newrank) + ChatColor.GRAY + "'.");
						} else {
