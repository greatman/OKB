...
public class OKDatabase
{
    ...
    {
        plugin = instance;
        dbm = new MySQL(OKLogger.getLog(), OKLogger.getPrefix(), (String) OKFunctions.getConfig("mysql.host"), (String) OKFunctions.getConfig("mysql.port"),
                (String) OKFunctions.getConfig("mysql.db"), (String) OKFunctions.getConfig("mysql.user"), (String) OKFunctions.getConfig("mysql.pass"));
